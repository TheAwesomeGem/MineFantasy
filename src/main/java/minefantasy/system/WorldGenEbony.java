...
public class WorldGenEbony extends WorldGenerator
{
	private final int logID = BlockListMF.log.blockID;
	private final int leavesID = BlockListMF.leaves.blockID;
    ...
    double branchDensity = 1.1D;
    double branchSlope = 0.581D;
    double scaleWidth = 1.1D;
    double leafDensity = 1.1D;
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                else
                {
                    ...
                    {
                        this.setBlockAndMetadata(this.worldObj, aint1[0], aint1[1], aint1[2], par6, metadata);
                        ++k1;
                    }
                }
            }
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.genTreeLayer(par1, l, par3, f, (byte)1, leavesID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(aint, aint1, logID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
            	this.placeBlockLine(aint, aint2, BlockListMF.log.blockID);
            }
        }
    }

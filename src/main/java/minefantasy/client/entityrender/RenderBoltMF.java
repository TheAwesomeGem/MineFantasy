...
public class RenderBoltMF extends Render
{
	public void renderArrow(EntityBoltMF bolt, double x, double y, double z, float xr, float yr)
    {
        this.loadTexture(data_minefantasy.image("/item/Projectile/" + bolt.getTexture() +".png"));
        GL11.glPushMatrix();
        GL11.glTranslatef((float)x, (float)y, (float)z);
        GL11.glRotatef(bolt.prevRotationYaw + (bolt.rotationYaw - bolt.prevRotationYaw) * yr - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(bolt.prevRotationPitch + (bolt.rotationPitch - bolt.prevRotationPitch) * yr, 0.0F, 0.0F, 1.0F);
        ...
        float var21 = (float)bolt.arrowShake - yr;
    ...
    {
        this.renderArrow((EntityBoltMF)entity, x, y, z, xr, yr);
    }
